...
const InauguralGuest: React.FC<InauguralGuestProps> = ({
    imageSrc = "https://cdn.a2ys.dev/images/photos/9cb2a3de-c134-4044-a927-f0cbc681fc35-arathiarun.webp", // detailed default
    guestName = "Dr Arathi Arun",
    role = "Inaugural Chief Guest",
    description = "Commonwealth Powerlifter"
}) => {
        ...
        >
            ...
            <div className="content-wrapper">
                ...
                <div className="center-image-container">
                    ...
                    <div className="name-wrapper" ref={textRef}>
                        <h2
                            style={{
